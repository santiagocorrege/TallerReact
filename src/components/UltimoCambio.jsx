  ...
  return (
    <>
      <div className="row justify-content-center align-items-center m-3">
        <h2 className="col-12 text-center pb-2">Informe</h2>
        ...
        <h6 className="text-start col-10">
          Cantidad Biberones{" "}
          <span class="badge text-bg-secondary">{cantidad.biberon}</span>
        </h6>
        <h6 className="text-start col-10">
          Cantidad Panales{" "}
          <span class="badge text-bg-secondary">{cantidad.panal}</span>
        </h6>
      </div>
    </>
  );
